...
<head>
    ...
    <title>
		Online Electronic Medical Record | Register User
	</title>
...
<body class="gray-bg">
    ...
    <div class="middle-box text-center loginscreen   animated fadeInDown">
        <div>
            ...
            <h3>Register to EMR+</h3>
            <p>Create account to see it in action.</p>
					{!! Form::open(['url' => 'register', 'method' => 'POST']) !!}
                        <div class="form-group row">
                            <div class="col-md-12">
                                <input id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ old('name') }}" required autofocus placeholder="Nama Klinik">
                                @if ($errors->has('name'))
