<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="form-group @if($errors->has('nama_asuransi')) has-error @endif">
		  {!! Form::label('nama_asuransi', 'Nama Asuransi', ['class' => 'control-label']) !!}
		  {!! Form::text('nama_asuransi' , null, ['class' => 'form-control rq']) !!}
		  @if($errors->has('nama_asuransi'))<code>{{ $errors->first('nama_asuransi') }}</code>@endif
		</div>
	</div>
</div>
<div class="row">
